...
/** Solo se guardan nombre y notas. Promedio y condición se calculan al responder. */
const alumnos = [];
let siguienteId = 1;
...
function calcularCondicion(promedio) {
  ...
  if (promedio < 8) return "aprobado"; // 6 o 7
  return "promocionado"; // 8 o más
}
...
// Listar todos (con promedio y condición derivados)
